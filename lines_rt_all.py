...
rt_feeds = dict()
rt_feeds['Lowell'] = 'http://realtime.mbta.com/developer/api/v2/predictionsbyroute?api_key=%s&route=CR-Lowell&format=json' % (api_key)
rt_feeds['Fitchburg/South Acton'] = 'http://realtime.mbta.com/developer/api/v2/predictionsbyroute?api_key=%s&route=CR-Fitchburg&format=json' % (api_key)
rt_feeds['Newburyport/Rockport'] = 'http://realtime.mbta.com/developer/api/v2/predictionsbyroute?api_key=%s&route=CR-Newburyport&format=json' % (api_key)
